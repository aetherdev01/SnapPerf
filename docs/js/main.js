...
async function loadUpdateJson(){
  var UPDATE_URL='https://aetherdev01.github.io/SnapPerf/server/update.json';
  ...
  if(mirror){var mirBtn=document.getElementById('mirrorBtn');if(mirBtn){mirBtn.href=mirror;mirBtn.style.display='';}}
