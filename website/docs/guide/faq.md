...
Many manufacturers have made modifications to the Android system that prevent SnapPerf from working properly.

## Start via wireless debugging: keeps showing "Searching for pairing service"

Please allow SnapPerf to run in the background.
...
## Start via wireless debugging/Start by connecting to a computer: SnapPerf randomly stops
