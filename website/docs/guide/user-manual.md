...
4. Enter pairing code in SnapPerf's notification until "**Pairing successfully**"
5. Back to SnapPerf and wait until connected (On some devices you need to click "**Start**" again)
...
Copy the command and paste into the terminal. If there is no problem, you will see that SnapPerf has started successfully in SnapPerf app.
